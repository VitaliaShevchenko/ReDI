...
export const recipes = [
  ...
  new Recipe(
    ...
    ["Chicken breast", "Bell pepper", "Onion", "Soy sauce", "Garlic"],
  ...
  new Recipe(
    ...
    ["Beetroot", "Goat cheese", "Walnut", "Rucola", "Balsamic vinegar"],
  ...
  new Recipe(
    ...
    ["Zucchini", "Bread", "Parmesan cheese"],
  ...
  new Recipe(
    ...
    ["Spaghetti", "Garlic", "Olive oil", "Bell pepper", "Parsley"],
    "Cook spaghetti according to package instructions. Sauté minced garlic in olive oil with bell pepper flakes until golden. Toss with cooked spaghetti and chopped parsley."
  ),
  new Recipe(
    "Herb-Roasted Chicken",
    ["Chicken breast", "Olive oil", "Garlic", "Rosemary", "Thyme"],
  ...
  new Recipe(
    ...
    ["Beetroot", "Olive oil", "Balsamic vinegar", "Goat cheese", "Walnut"],
  ...
  new Recipe(
    "Stuffed Mushrooms",
    ["Mushroom", "Cream cheese", "Garlic", "Parmesan cheese", "Bread"],
  ...
  new Recipe(
    "Simple Corn Salad",
    ["Canned corn", "Olive oil", "Tomato", "Red onion", "Cilantro", "Lime"],
  ...
  new Recipe(
    ...
    ["Cucumber", "Tomato", "Red onion", "Olive oil", "Lime", "Cilantro"],
  ...
  new Recipe(
    ...
    ["Chicken breast", "Olive oil", "Garlic", "Spinach", "Cream cheese"],
  ...
  new Recipe(
    ...
    ["Cabbage", "Apple", "Onion", "Lemon", "Honey", "Mustard", "Olive oil", "Salt", "Pepper"],
  ...
  new Recipe(
    ...
    ["Swiss chard", "Egg", "Feta cheese", "Onion", "Garlic", "Olive oil", "Salt", "Pepper"],
  ...
  new Recipe(
    ...
    ["Apple", "Cranberry", "Flour", "Oats", "Sugar", "Butter", "Cinnamon", "Nutmeg", "Salt"],
    "Mix sliced apples and cranberries with a bit of flour, sugar, and spices. Spread in a baking dish. Mix oats, flour, sugar, and butter until crumbly. Sprinkle over fruit mixture. Bake until golden and bubbly."
  ),
  new Recipe(
    "Orange Glazed Chicken",
    ["Chicken thighs", "Orange", "Honey", "Soy sauce", "Garlic", "Ginger", "Olive oil", "Salt", "Pepper"],
  ...
  new Recipe(
    ...
    ["Plum", "Almond", "Flour", "Oats", "Sugar", "Butter", "Cinnamon", "Nutmeg", "Salt"],
  ...
  new Recipe(
    ...
    ["Kiwi", "Banana", "Spinach", "Yogurt", "Honey", "Lime"],
  ...
  new Recipe(
    ...
    ["Chicken wings", "Garlic powder", "Rosemary", "Olive oil", "Salt", "Pepper"],
  ...
  new Recipe(
    ...
    ["Carp", "Parsley", "Dill", "Garlic powder", "Butter", "Salt", "Pepper"],
    "Mix chopped herbs with garlic powder and softened butter. Spread over carp. Bake until fish is tender."
  ),
  new Recipe(
  ...
  new Recipe(
    ...
    ["Pork minced meat", "Bread", "Egg", "Marjoram", "Salt", "Pepper", "Olive oil"],
